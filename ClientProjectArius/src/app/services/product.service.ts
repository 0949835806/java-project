...
export class ProductService {
  ...
  getListProByCateId(id: number):Observable<any>{
    return this.http.get<any>('http://localhost:8888/api/product/getProByCateId/'+id);
  }

  getNewProduct():Observable<any>{
    return this.http.get<any>('http://localhost:8888/api/product/getProNewArrivals')
  }

  getProBestSaler():Observable<any>{
    return this.http.get<any>('http://localhost:8888/api/product/getProBestSale')
  }
}
